...
Domain: LAB.LOCAL
File Server: Windows Server (SMB Shares)
...
General Share	✔ Allowed
Sales Share	✔ Allowed (after fix)
IT Share	❌ Denied (expected)
...
Effective troubleshooting requires isolating variables rather than guessin
